...
export const DASHBOARD_VIEWS: Record<DashboardViewId, DashboardView> = {
  "wildfire-firms": {
    ...
    kind: "wildfire-firms",
    emoji: "🔥",
    shortLabel: "Wildfire Monitoring",
    longLabel: "Wildfire · Live NASA FIRMS satellite hotspots",
    description:
      "Real-time VIIRS satellite fire detection across Indonesia, refreshed every 30 minutes. FRP-weighted risk scoring + provincial classification.",
    status: "live",
    statusLabel: "Live",
  },
  "scenario-a": {
